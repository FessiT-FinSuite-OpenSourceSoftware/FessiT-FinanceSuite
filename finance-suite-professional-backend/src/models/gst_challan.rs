...
pub struct GstChallan {
    ...
    /// Type of payment (e.g., "GST payable by taxpayer")
    #[serde(default)]
...
pub type CreateGstChallanRequest = GstChallan;
pub type UpdateGstChallanRequest = GstChallan;

...
export const countriesData = {
  countries: [
    ...
    },
    {
      ...
      states: ['New South Wales','Victoria','Queensland','Western Australia','Tasmanian','South Australia'],
    },
    {
      code: '+43',
      country: 'Austria',
    ...
    },
    {
      ...
      states: ['Abseron Rayonu','Agcabadi Rayonu','Agdam Rayonu','Agdas Rayonu','Agstafa Rayonu','Agsu Rayonu','Astara Rayonu','Balakan Rayonu','Barda Rayonu','Beylaqan Rayonu','Bilasuvar Rayonu','Cabrayil Rayonu','Calilabad Rayonu','Daskasan Rayonu','Davaci Rayonu','Fuzuli Rayonu','Gadabay Rayonu','Goranboy Rayonu','Goycay Rayonu','Haciqabul Rayonu','Imisli Rayonu','Ismayilli Rayonu','Kalbacar Rayonu','Kurdamir Rayonu','Lacin Rayonu','Lankaran Rayonu','Lerik Rayonu','Masalli Rayonu','Neftcala Rayonu','Oguz Rayonu','Qabala Rayonu','Qax Rayonu','Qazax Rayonu','Qobustan Rayonu','Quba Rayonu','Qubadli Rayonu','Qusar Rayonu','Saatli Rayonu','Sabirabad Rayonu','Saki Rayonu','Salyan Rayonu','Samaxi Rayonu','Samkir Rayonu','Samux Rayonu','Siyazan Rayonu','Susa Rayonu','Tartar Rayonu','TovuzRayonu','Ucar Rayonu','Xacmaz Rayonu','Xanlar Rayonu','Xizi Rayonu','Xocali Rayonu','Xocavand Rayonu','Yardimli Rayonu','Yevlax Rayonu','Zangilan Rayonu','Zaqatala Rayonu','Zardab Rayonu','Ali Bayramli Sahari','Baki Sahari','Ganca Sahari','Lankaran Sahari','Mingacevir Sahari','Naftalan Sahari','Saki Sahari','Sumqayit Sahari','Susa Sahari','Xankandi Sahari','Yevlax Sahari','Naxcivan Muxtar'],
    },
    {
      code: '+1 242',
      country: 'Bahamas',
    ...
    },
    {
      ...
      states: ['Barima-Waini','Cuyuni-Mazaruni','Demerara-Mahaica','East Berbice-Corentyne','Essequibo Islands-West Demerara','Mahaica-Berbice','Pomeroon-Supenaam','Potaro-Siparuni','Upper Demarara-Berbice','Upper Takutu-Upper Essequibo'],
    },
    {
      code: '+509',
      country: 'Haiti',
    ...
    },
    {
      ...
      states: ['Attapu','Bokeo','Bolikhamxai','Champasak','Houaphan','Khammouan','Louangnamtha','Louangphrabang','Oudomxai','Phongsali','Salavan','Savannakhet','Viangchan','Xaignabouli','Xaisomboun','Xekong','Xiangkhoang'],
    },
    {
      code: '+371',
      country: 'Latvia',
    ...
    },
    {
      ...
      states: ['An Giang','Bac Giang','Bac Kan','Bac Lieu','Bac Ninh','Ba Ria-Vung Tau','Ben Tre','Binh Dinh','Binh Duong','Binh Phuoc','Binh Thuan','Ca Mau','Cao Bang','Dac Lak','Dac Nong','Dien Bien','Dong Nai','Dong Thap','Gia Lai','Ha Giang','Hai Duong','Ha Nam','Ha Tay','Ha Tinh','Hau Giang','Hoa Binh','Hung Yen','Khanh Hoa','Kien Giang','Kon Tum','Lai Chau','Lam Dong','Lang Son','Lao Cai','Long An','Nam Dinh','NgheAn','Ninh Binh','Ninh Thuan','Phu Tho','Phu Yen','Quang Binh','Quang Nam','Quang Ngai','Quang Ninh','Quang Tri','Soc Trang','Son La','Tay Ninh','Thai Binh','Thai Nguyen','Thanh Hoa','Thua Thien-Hue','Tien Giang','Tra Vinh','Tuyen Quang','Vinh Long','Vinh Phuc','Yen Bai','Can Tho','Da Nang','Hai Phong','Hanoi','Ho Chi Minh'],
    },
    {
      code: '+967',
      country: 'Yemen',

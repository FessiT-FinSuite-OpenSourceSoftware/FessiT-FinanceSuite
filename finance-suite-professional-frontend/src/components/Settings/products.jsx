        ...
        <div className="fixed inset-0 z-200 flex items-center justify-center bg-black/60 p-4">
          <div className="w-full max-w-4xl max-h-[90vh] overflow-y-auto rounded-2xl bg-white shadow-2xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 p-6">
              ...
              <Field label="Stocks" name="stocks" type="number" value={form.stocks} onChange={handleFormChange} placeholder="0" />
              ...
              <Field label="Purchase Price (Without Tax)" name="purchasePrice" type="number" value={form.purchasePrice} onChange={handleFormChange} placeholder="0" />
          ...
          <table className="w-full">
            <thead className="bg-slate-50 border-b border-slate-200">
              <tr>
                ...
                <th className="px-4 py-3 text-left text-xs font-semibold uppercase tracking-wider text-slate-600">Sale Price</th>
              ...
              {paginatedProducts.map((product) => {
                ...
                return (
                  <React.Fragment key={product.id}>
                    <tr
                      className="cursor-pointer hover:bg-slate-50/70 transition-colors align-top"
                    ...
                    >
                        ...
                        {product.image ? (
                          <button
                            ...
                            onClick={(e) => {
                              ...
                              if (src) openPreviewModal(src, product.name || "Product Image");
                            }}
                            className="block"
                          >
                            <img
                          ...
                          <div className="h-14 w-14 rounded-xl border border-slate-200 bg-slate-50 flex items-center justify-center text-xs text-slate-400">
                            No image
                          </div>
                        )}
                      </td>
                      <td className="px-4 py-4">
                        <div className="whitespace-nowrap font-semibold text-slate-900">{product.name}</div>
                      ...
                      <td className="px-4 py-4 text-sm text-slate-700">{product.itemCode}</td>
                      <td className="px-4 py-4">
                      ...
                      <td className="px-4 py-4">
                        <div className="inline-flex items-center gap-2 whitespace-nowrap">
                          <span className={`text-sm font-semibold ${stockCountClass(product.stocks)}`}>{fmt(product.stocks)}</span>
                          {/* <span className={`inline-flex rounded-full px-2.5 py-1 text-xs font-semibold ${stockBadgeClass(product.stocks)}`}>
                            {stockStatus(product.stocks)}
                          </span> */}
                        </div>
                      </td>
                      <td className="px-4 py-4">
                        <div className="inline-flex items-center gap-1 whitespace-nowrap text-sm font-semibold text-slate-900">
                          <span>Rs.</span>

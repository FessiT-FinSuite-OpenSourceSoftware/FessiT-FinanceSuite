...
const InvoiceReportGeneration = ({ invoiceData, onBack }) => {
  ...
  return (
    <div className="bg-gray-100 min-h-screen py-6 print:bg-white">
      {/* Center everything, constrain width to A4-ish (794px) */}
      <div className="w-full flex justify-center">
        <div
          className="invoice-a4-container"
          style={{ width: "794px" }}
        >
          {/* Top bar – hidden in print, same width as invoice */}
          <div className="print-hidden w-full mb-4 flex justify-between items-center px-1">
            {/* Back + Preview title */}
            <div
            ...
            >
              <ArrowLeft
                className="w-5 h-5 text-gray-700 hover:text-gray-900 transition"
              />
            ...
            <div className="flex justify-between items-start mb-6">
              ...
              <div className="text-right">
                <h2 className="text-lg font-semibold text-gray-900">
                  {isInternational ? "EXPORT INVOICE" : "TAX INVOICE"}
                </h2>
              ...
              <table className="w-full border-t border-b border-gray-400 border-collapse">
                <tbody>
                  ...
                  <tr>
                    ...
                    {/* RIGHT COLUMN – P.O. + LUT/IEC for international */}
                  ...
                  <tr>
                    ...
                    <td className="w-1/2 align-top border-r border-t border-gray-400 px-4 py-3">
                      ...
                      {/* GSTIN only meaningful for domestic, but harmless to show if set */}
                      {isDomestic && (
                        <p className="text-xs text-gray-700 mt-1">
